...
Je suis un robot de filtrage automatique avancé avec fonction de clonage. 😍
Je peux fournir tous les films et séries télévisées. 😇
Ajoutez-moi à votre groupe et donnez-moi un administrateur. 😌
Visualisez mes pouvoirs et profitez de mon service</b>"""
...
<b>ᴅᴇᴠ: <a herf=https://t.me/zosman_official>✪ zoѕ-мan ✪</a></b>"""
...
<b>⪼ EG:</b>
</code>/batch https://t.me/cinemalakay/1 https://t.me/cinemalakay/10</code>"""
...
Fʀᴇᴇ Dɪꜱᴋ: {}"""
    ...
    BUTTON_LOCK_TEXT = "Désolé {query}\nEffectuez votre propre requête 😤"
   
    FORCE_SUB_TEXT = "Veuillez rejoindre mon canal pour utiliser ce bot!"
   
    WELCOM_TEXT = """Félicitations {user} 💞

Bienvenue sur {Star+ Team}.

ꜱʜᴀʀᴇ & ꜱᴜᴩᴩᴏʀᴛ, ʀᴇqᴜᴇꜱᴛ ʏᴏᴜ ᴡᴀɴᴛᴇᴅ ᴍᴏᴠɪᴇꜱ"""
  
    IMDB_TEMPLATE = """<b>✨Voici le résultat de votre requête sur 👉 {query}</b>

🍿 : <a href=>{title}</a>
🎭 : {genres}
📀 : <a href=/releaseinfo>{year}</a>
🌟 : <a href=/ratings>{rating}</a>/10"""
